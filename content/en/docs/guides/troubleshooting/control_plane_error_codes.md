...
# Troubleshooting osm-edge Control Plane Error Codes

## Error Code Descriptions

If error codes are present in the osm-edge error logs or detected from the osm-edge error code metrics, the `osm support error-info` cli tool can be used gain more information about the error code.
...
+------------+----------------------------------------------------------------------------------+
| E4150      | Failed initial cache sync for config.openservicemesh.io informer.                               |
+------------+----------------------------------------------------------------------------------+
...
|            | cache.                                                                           |
+------------+----------------------------------------------------------------------------------+
| E5009      | The Aggregate Discovery Server (ADS) created by the osm-edge controller failed to     |
|            | start.                                                                           |
+------------+----------------------------------------------------------------------------------+
...
|            | proxy.                                                                           |
+------------+----------------------------------------------------------------------------------+
| E5012      | The envoy proxy has not completed the initialization phase and it is not ready   |
...
+------------+----------------------------------------------------------------------------------+
| E5015      | An Envoy egress cluster which routes traffic to its original destination could   |
|            | not be configured. When a Host is not specified in the cluster config, the       |
|            | original destination is used.                                                    |
+------------+----------------------------------------------------------------------------------+
| E5016      | An Envoy egress cluster that routes traffic based on the specified Host resolved |
|            | using DNS could not be configured.                                               |
+------------+----------------------------------------------------------------------------------+
| E5017      | An Envoy cluster that corresponds to a specified upstream service could not be   |
|            | configured.                                                                      |
+------------+----------------------------------------------------------------------------------+
| E5018      | The meshed services corresponding a specified Envoy proxy could not be listed.   |
+------------+----------------------------------------------------------------------------------+
| E5019      | Multiple Envoy clusters with the same name were configured. The duplicate        |
