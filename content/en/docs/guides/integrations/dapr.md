...
11. Cleanup:
    ...
    4. To remove osm-edge's cluster wide resources after uninstallation, run the following command. See the [uninstall guide](/docs/guides/operating/uninstall/) for more context and information.
